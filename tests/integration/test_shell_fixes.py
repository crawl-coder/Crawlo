...
class TestSimpleFetcherHTTPMethods:
    ...
    async def test_simple_fetcher_get_method(self):
        """测试 GET 方法"""
        from crawlo.commands.shell_core import _SimpleFetcher
...
class TestMockCrawlerSettings:
    ...
    def test_mock_crawler_no_settings(self):
        ...
        from crawlo.commands.shell_core import _MockCrawler
        
        with patch('crawlo.commands.shell_core.SettingManager') as mock_sm:
            mock_instance = Mock()
    ...
    def test_mock_crawler_setting_manager_failure(self):
        ...
        with patch('crawlo.commands.shell_core.SettingManager', side_effect=ImportError):
            crawler = _MockCrawler()
...
class TestExceptionHandling:
    ...
    async def test_downloader_adapter_close_logs_error(self):
        """测试下载器关闭时记录错误"""
        from crawlo.commands.shell_core import _DownloaderAdapter
