...
SCHEDULER_QUEUE_NAME = f'test_cli_project:requests'
QUEUE_MAX_RETRIES = 3
QUEUE_TIMEOUT = 300
...
MYSQL_DB = os.getenv('MYSQL_DB', 'test_cli_project')
MYSQL_TABLE = 'test_cli_project_data'
...
MONGO_DATABASE = 'test_cli_project_db'
MONGO_COLLECTION = 'test_cli_project_items'
...
REDIS_KEY = f'test_cli_project:fingerprint'
REDIS_TTL = 0
CLEANUP_FP = 0
FILTER_DEBUG = True
...
PIPELINES = [
    ...
    # 'test_cli_project.pipelines.DatabasePipeline',        # 自定义数据库管道
