...
The modular documentation approach organizes information by functional components, making it easier to:
...
- [Core Module](core/index_en.md) - The heart of Crawlo with Engine, Scheduler, and Processor
...
- [Extension Module](extension/index_en.md) - Additional functionality and monitoring components

## How to Navigate

1. **Start with Core**: If you're new to Crawlo, start with the [Core Module](core/index_en.md) documentation
2. **Follow Your Interests**: Jump to the module that interests you most
3. **Check Examples**: Look for code examples in each documentation page
4. **Refer to Configuration**: See how to configure each module for your specific needs

## Getting Started

If you're just getting started with Crawlo, we recommend reading in this order:

1. [Core Module](core/index_en.md) - Understand the fundamental architecture
2. [Downloader Module](downloader/index_en.md) - Learn about fetching web content
3. [Middleware Module](middleware/index_en.md) - Discover request/response processing
...
1. File an issue on our GitHub repository
