...
# ============================== 项目基本信息 ==============================
PROJECT_NAME = 'news_pulse_tracker'
VERSION = '1.0.0'
...
SCHEDULER_QUEUE_NAME = f'crawlo:news_pulse_tracker:queue:requests'  # 使用统一命名规范
QUEUE_MAX_RETRIES = 3
QUEUE_TIMEOUT = 300
...
MYSQL_DB = os.getenv('MYSQL_DB', 'news_pulse_tracker')
MYSQL_TABLE = 'news_pulse_tracker_data'
MYSQL_BATCH_SIZE = 100
MYSQL_USE_BATCH = False  # 是否启用批量插入

# --- MongoDB 配置 ---
MONGO_URI = os.getenv('MONGO_URI', 'mongodb://localhost:27017')
MONGO_DATABASE = 'news_pulse_tracker_db'
MONGO_COLLECTION = 'news_pulse_tracker_items'
...
PIPELINES = [
    ...
    # 'news_pulse_tracker.pipelines.DatabasePipeline',        # 自定义数据库管道
...
LOG_LEVEL = 'INFO'
STATS_DUMP = True
LOG_FILE = f'logs/news_pulse_tracker.log'
