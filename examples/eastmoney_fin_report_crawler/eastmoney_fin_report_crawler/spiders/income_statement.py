...
from data.field_mapping import INCOME_STATEMENT_FIELD_MAPPING
...
class IncomeStatementSpider(Spider):
    """
    ...
    custom_settings = {
        "DOWNLOAD_DELAY": 5,
        "MYSQL_TABLE": "listed_income_statement",
    }
        ...
        try:
            ...
            for idx, row in enumerate(rows, 1):
                try:
                    ...
                    # 第一步：填充所有字段
                    for field_name, original_key in INCOME_STATEMENT_FIELD_MAPPING.items():
